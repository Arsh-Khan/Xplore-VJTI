                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                onTap: (){
                                  const url = 'https://www.linkedin.com/in/rushi-jani-4a71ab233';
                                  launch(url);
                                },
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                onTap: (){
                                  const url = 'https://www.linkedin.com/in/arsh-khan-b0613622b';
                                  launch(url);
                                },
                                child: Image.asset('assets/linkedin.png'),
                                //fit: BoxFit.contain
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                onTap: (){
                                  const url = 'https://www.linkedin.com/in/ruturaj-rao-855b9b233';
                                  launch(url);
                                },
                                child: Image.asset('assets/linkedin.png'),
                                //fit: BoxFit.contain
